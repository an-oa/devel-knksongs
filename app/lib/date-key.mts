 ...
 * @returns {number | null}
 */
export function parseDateKey(raw: string | null | undefined): number | null {
    if (!raw) return null;
 ...
 */
export function dateKeyToParts(key: number): { year: number; month: number; day: number } {
...
export function isWithinDateRange(
    row: { dateKey?: number | null },
    fromKey: number | null | undefined,
    toKey: number | null | undefined
): boolean {
