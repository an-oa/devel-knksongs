export const SEARCH_STATE_CURRENT_VERSION = 2;
 ...
 *   formats?: string[]
 * }} input
 * @returns {{ version: number, query: string, relayOnly: boolean, harmonyOnly: boolean, frameScope: string, dateFrom: string, dateTo: string, formats: string[] }}
 */
export function buildStoredSearchStatePayload(input) {
    return {
        ...
        frameScope: typeof input.frameScope === "string" ? input.frameScope : "",
...
export function parseStoredSearchStatePayload(text, options = {}) {
    ...
    return {
        ...
        frameScope: typeof payload.frameScope === "string" ? payload.frameScope : "",
