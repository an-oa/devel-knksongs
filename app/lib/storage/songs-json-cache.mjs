 ...
 */
function openTextCacheDatabase({ dbName, storeName }) {
    // テキストキャッシュ用の IndexedDB を開く。
    if (!canUseIndexedDb()) {
 ...
 */
export function createIndexedDbTextCacheStore(options) {
    // IndexedDB へテキストを保存するキャッシュストアを作成する。
    const {
        cacheKey,
 ...
 * @returns {TextCacheStore}
 */
export function createLegacyLocalStorageTextCacheAdapter(options) {
